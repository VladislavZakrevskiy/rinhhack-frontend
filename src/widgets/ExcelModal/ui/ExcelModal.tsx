...
import { useState } from "react";
  ...
  const formulasHelpText = [
    ...
    { name: "BINOM.DIST.RANGE(A1; B2; C1; D1)", description: "Возвращает вероятность попадания в определенный диапазон значений для биномиального распределения." },
    { name: "BINOM.INV(A1; B2; C1)", description: "Возвращает наименьшее значение, для которого кумулятивное биномиальное распределение >= заданному критерию." },
    ...
    { name: "CONFIDENCE.T(A1; B2; C1)", description: "Возвращает интервал доверия для среднего значения, используя t-распределение." },
    ...
    { name: "GAUSS(A1)", description: "Возвращает вероятность нормального распределения для среднего значения 0 и стандартного отклонения 1." },
    ...
    { name: "HLOOKUP(A1; B2; C1)", description: "Выполняет поиск значения в строках массива и возвращает значение из указанной строки." },
    ...
    { name: "IFS(A1; B2; C1; D1)", description: "Проверяет несколько условий и возвращает значение для первого истинного." },
    ...
    { name: "INDEX(A1; B2; C1)", description: "Возвращает значение элемента из таблицы или диапазона по заданным координатам." },
    ...
    { name: "WORKDAY.INTL(A1; B2; [weekend]; [holidays])", description: "Возвращает дату, с учетом рабочих дней и выходных." },
